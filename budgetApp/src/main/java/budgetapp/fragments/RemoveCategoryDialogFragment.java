...
public class RemoveCategoryDialogFragment
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (activity.removeCategory(getArguments().getString("chosenCategory")) == true) {
                    Toast.makeText(view.getContext(),
                        "Successfully removed " + getArguments().getString("chosenCategory"), Toast.LENGTH_LONG).show();
                } else
                    Toast.makeText(view.getContext(), "Could not remove " + getArguments().getString("chosenCategory"),
