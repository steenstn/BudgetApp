...
public class AddEventDialogFragment
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (mode.equalsIgnoreCase("add_event")) {
                    ...
                    if (name != null && !name.equalsIgnoreCase("")) {
                        Event event = new Event(0, name, BudgetFunctions.getDateString(), BudgetFunctions
                            .getDateString(), comment, flags);
                        activity.createEvent(event);
                    }
                } else if (mode.equalsIgnoreCase("edit_event")) {
                    parseFields();
                    if (name != null && !name.equalsIgnoreCase("")) {
                        Event newEvent = new Event(0, name, BudgetFunctions.getDateString(), BudgetFunctions
                            .getDateString(), comment, flags);
