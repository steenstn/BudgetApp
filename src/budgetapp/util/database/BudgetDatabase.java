...
public class BudgetDatabase extends SQLiteOpenHelper {
	...
	public static final String DATABASE_CREATE_TABLE_CASHFLOW = "create table "
			...
			+ " double, " + COLUMN_DATE + " text, " + COLUMN_CATEGORY
			+ " text, " + COLUMN_FLAGS + " integer, " + COLUMN_COMMENT
			+ " text);";
	...
	public static final String DATABASE_CREATE_TABLE_CATEGORIES = "create table "
			...
			+ " integer not null, "
			+ COLUMN_VALUE
			+ " double not null, " + COLUMN_FLAGS + " integer);";
	...
	public static final String DATABASE_CREATE_TABLE_INSTALLMENTS = "create table "
			...
			+ COLUMN_VALUE
			+ " double, "
			+ COLUMN_DAILY_PAYMENT
			+ " double, "
			+ COLUMN_DATE_LAST_PAID
			+ " text, "
			+ COLUMN_FLAGS
			+ " integer); ";

	public static final String DATABASE_CREATE_TABLE_INSTALLMENT_DAYFLOW_PAID = "create table "
			+ TABLE_INSTALLMENT_DAYFLOW_PAID
			+ "("
			+ COLUMN_ID
			+ " integer primary key autoincrement, "
			+ COLUMN_INSTALLMENT_ID
			+ " integer, "
			+ COLUMN_DAYFLOW_ID
			+ " integer, "
			+ COLUMN_VALUE
	...
	public static final String DATABASE_CREATE_TABLE_EVENTS = "create table "
			...
			+ COLUMN_COMMENT + " text," + COLUMN_FLAGS + " integer);";

	public static final String DATABASE_CREATE_TABLE_EVENT_TRANSACTION = "create table "
			+ TABLE_EVENT_TRANSACTION
			+ "("
			+ COLUMN_ID
			+ " integer primary key autoincrement, "
			+ COLUMN_EVENT_ID
			+ " integer," + COLUMN_TRANSACTION_ID + " integer);";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		case 7: // Updating from 2.2
			db.execSQL("ALTER TABLE " + TABLE_CASHFLOW + " ADD COLUMN "
					+ COLUMN_COMMENT);
		case 8: // Updating from 2.2, changing to doubles by creating new tables
			...
			db.execSQL("create table temp" + "(" + COLUMN_ID
					...
					+ " text, " + COLUMN_NUM + " integer not null, "
					+ COLUMN_VALUE + " double not null, " + COLUMN_FLAGS
					+ " integer);");
			...
			db.execSQL("create table temp" + "(" + COLUMN_ID
					...
					+ " text, " + COLUMN_VALUE + " double not null, "
		...
		System.out.println("Updated database from " + oldVersion + " to "
				+ newVersion);
