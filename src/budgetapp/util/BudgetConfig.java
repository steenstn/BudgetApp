...
public class BudgetConfig {
     ...
     * 
     * @param theField
     *            - The enum field to fetch
     * @return A double from the listed enum values
     * @throws IllegalArgumentException
     *             () - If the field entered is not a double in the enum list
     */
     ...
     * @return A double from the listed enum values
     * @throws IllegalArgumentException
     *             () - If the field entered is not a String in the enum list
     */
     ...
     * @return A double from the listed enum values
     * @throws IllegalArgumentException
     *             () - If the field entered is not a boolean in the enum list
     */
     ...
     * 
     * @param theField
     *            - Enum of the variable to write to
     * @param theValue
     *            - The double to write
     * @throws IllegalArgumentException
     *             () - If the field is not one of the double variables
     */
     ...
     *            - The String to write
     * @throws IllegalArgumentException
     *             () - If the field is not one of the String variables
     */
     ...
     * @throws IllegalArgumentException
     *             () - If the field is not one of the boolean variables
     */
